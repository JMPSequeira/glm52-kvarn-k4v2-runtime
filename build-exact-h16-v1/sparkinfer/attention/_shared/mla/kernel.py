...
def _kvarn_mla_decode_grid_flat_launch(
    ...
    chunks_per_split, exact_pool_only, fuse_kvarn_hadamard,
    exact_h16=False,
) -> None:
    ...
    spec = KernelCompileSpec.from_fields(kernel_id, 1 if exact_h16 else 2, *spec_fields)
