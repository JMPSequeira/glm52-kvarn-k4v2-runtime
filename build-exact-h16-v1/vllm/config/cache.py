...
# Self-describing MLA KVarN dtype strings: the string itself carries the
# latent bit width (k2/k4/k5) and the group size (g64/g128); width and group
# are parsed from it by KVarNMLAConfig.from_cache_dtype (no env override).
KVARN_MLA_CACHE_DTYPES = frozenset(
    {
        "kvarn_mla_k2_g64",
        "kvarn_mla_k4_g64",
        "kvarn_mla_k5_g64",
