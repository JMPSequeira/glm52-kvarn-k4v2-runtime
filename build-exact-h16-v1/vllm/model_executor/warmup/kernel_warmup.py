...
from vllm.model_executor.layers.quantization.exl3 import warmup_exl3_linear
...
def kernel_warmup(worker: "Worker"):
    ...
    warmed_exl3 = warmup_exl3_linear(
        worker.get_model(),
        cudagraph_capture_sizes=cudagraph_capture_sizes,
    )
    if warmed_exl3:
        logger.info("Warmed up %d EXL3 dense GEMM signatures.", warmed_exl3)
