    ...
    def forward(
        ...
        if self.q_lora_rank is not None:
            ...
            if self.fused_qkv_a_proj is not None:
                assert self.q_a_proj is None and self.kv_a_proj_with_mqa is None, (
                    "fused_qkv_a_proj cannot be combined with separate "
                    "q_a_proj or kv_a_proj_with_mqa"
                )
                ...
                assert self.q_a_proj is not None, (
                    "q_a_proj is required when fused_qkv_a_proj is not provided"
                )
                assert self.kv_a_proj_with_mqa is not None, (
                    "kv_a_proj_with_mqa is required when fused_qkv_a_proj "
                    "is not provided"
                )
