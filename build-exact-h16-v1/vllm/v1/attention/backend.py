...
class CommonAttentionMetadata:
    ...
    """Graph-static proof that every selected KVarN MLA row is exact-backed."""
    for_cudagraph_capture: bool = False
    """Whether metadata is being constructed for graph capture dummy rows."""
    ...
    def unpadded(
        ...
        return CommonAttentionMetadata(
            ...
            kvarn_mla_exact=self.kvarn_mla_exact,
