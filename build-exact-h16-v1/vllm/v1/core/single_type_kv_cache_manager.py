...
class SingleTypeKVCacheManager(ABC):
    ...
    def __init__(
        ...
        # One manager block covers the physical CP shards for this cache group;
        # partial indexer replication deliberately differs from model DCP.
    ...
    def apply_lockstep_cow(
        ...
        """Mirror a peer manager's CoW substitution with the same block ID."""
