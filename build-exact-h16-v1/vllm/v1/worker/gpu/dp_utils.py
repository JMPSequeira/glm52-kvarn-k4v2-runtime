...
def sync_cudagraph_and_dp_padding(
    ...
    tensor[4][dp_rank] = int(kvarn_mla_exact)
    ...
    kvarn_mla_exact_across_dp = tensor[4]
    ...
    active_ranks = num_tokens_across_dp > 0
    synced_kvarn_mla_exact = bool(
        torch.all(kvarn_mla_exact_across_dp[active_ranks] == 1).item()
    )
    ...
    synced_desc = cudagraph_manager.dispatch(
        ...
        kvarn_mla_exact=synced_kvarn_mla_exact,
    )
