...
class DSparkDeepseekV4ForCausalLM(nn.Module):
    # Speculators checkpoints ship the verifier head used during training.
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = "") -> None:
        ...
        # Standalone Speculators checkpoints load their own draft head.
        ...
        # Optional rowwise-fp8 copy of the draft lm_head, used ONLY for
        # draft-proposal logits. Materialized eagerly at load time.
    ...
    def maybe_init_fp8_draft_head(self) -> None:
        """Materialize the optional rowwise-fp8 draft head copy.
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        """Load standalone Speculators DSpark weights."""
    ...
    def _remap_dspark_name(self, name: str) -> str | None:
        """Map a standalone Speculators checkpoint name."""
        if name == "lm_head.weight":
            return name
