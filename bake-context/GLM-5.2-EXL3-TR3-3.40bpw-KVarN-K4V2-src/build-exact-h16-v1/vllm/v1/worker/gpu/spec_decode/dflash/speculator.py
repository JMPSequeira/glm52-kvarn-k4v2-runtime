...
class DFlashSpeculator(DraftModelSpeculator):
    ...
    def propose(
        ...
        draft_seq_lens_upper_bound = torch.full(
            (num_reqs_padded,),
        ...
        draft_attn_metadata = self._build_draft_attn_metadata(
            ...
            num_query_per_req=active_query_len,
            causal=self._group_causal,
            seq_lens_cpu_upper_bound=draft_seq_lens_upper_bound,
            max_seq_len_upper_bound=self.draft_max_seq_len,
        )
