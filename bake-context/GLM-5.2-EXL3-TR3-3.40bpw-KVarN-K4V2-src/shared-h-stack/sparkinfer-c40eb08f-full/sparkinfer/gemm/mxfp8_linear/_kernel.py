...
from sparkinfer._lib.dense_gemm import dense_gemm, dense_gemm_fused_quant_a
...
def _mxfp8_linear_fused_op(
    ...
    if (
        tokens <= 4
        and source_for_quant.dtype == torch.bfloat16
        and int(padded_in_features) == 512
        and int(out_features) == 7168
    ):
