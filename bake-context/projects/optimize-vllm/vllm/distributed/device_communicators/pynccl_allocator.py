...
from vllm.utils.nccl import find_nccl_include_paths, find_nccl_library
...
def compile_nccl_allocator():
    ...
    try:
        ...
        nccl_library = find_nccl_library()
        nccl_ldflags = (
            [nccl_library] if os.path.isabs(nccl_library) else ["-lnccl"]
        )
        load_inline(
            name=nccl_allocator_libname,
            cpp_sources=nccl_allocator_source,
            with_cuda=True,
            extra_ldflags=nccl_ldflags,
