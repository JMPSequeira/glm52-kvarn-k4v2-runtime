...
CACHE=/home/js/m2/glm52-vllm-cache
IMAGE=localhost/glm52-shared-h-mixed-mcg:r634-k34-v3-native-k5-v1
ROUTE_PACK_OVERLAY=${ROUTE_PACK_OVERLAY-$ROOT/runtime/build-exact-h16-v7/sparkinfer/moe/_shared/kernels/w4a16/route_pack.py}
...
MODEL_TARGET=${MODEL_TARGET:-$ROOT/weights/full-expert-340/target}
...
DSPARK_NGRAM_ASSIST_OVERLAY=${DSPARK_NGRAM_ASSIST_OVERLAY:-$ROOT/runtime/build-exact-h16-v1/vllm/v1/worker/gpu/spec_decode/dspark/ngram_assist.py}
...
MTP_TABLE_SPECULATOR_OVERLAY=${MTP_TABLE_SPECULATOR_OVERLAY:-$ROOT/runtime/build-exact-h16-v1/vllm/v1/worker/gpu/spec_decode/mtp/speculator.py}
MTP_TABLE_EXTENSION_OVERLAY=${MTP_TABLE_EXTENSION_OVERLAY:-$ROOT/runtime/build-exact-h16-v1/vllm/v1/worker/gpu/spec_decode/mtp/table_extension.py}
...
DFLASH_SPECULATOR_OVERLAY=${DFLASH_SPECULATOR_OVERLAY:-$ROOT/runtime/build-exact-h16-v1/vllm/v1/worker/gpu/spec_decode/dflash/speculator.py}
DSPARK_SPECULATOR_OVERLAY=${DSPARK_SPECULATOR_OVERLAY:-$ROOT/runtime/build-exact-h16-v1/vllm/v1/worker/gpu/spec_decode/dspark/speculator.py}
V1_MODEL_RUNNER_OVERLAY=${V1_MODEL_RUNNER_OVERLAY:-$ROOT/runtime/build-exact-h16-v1/vllm/v1/worker/gpu_model_runner.py}
...
MODEL_RUNNER_OVERLAY=${MODEL_RUNNER_OVERLAY:-$ROOT/runtime/active-r634-runner/model_runner.py}
...
ALLREDUCE_RMS_FUSION_OVERLAY=${ALLREDUCE_RMS_FUSION_OVERLAY-$ROOT/runtime/build-exact-h16-v1/vllm/compilation/passes/fusion/allreduce_rms_fusion.py}
MXFP8_KERNEL_OVERLAY=${MXFP8_KERNEL_OVERLAY:-$ROOT/runtime/shared-h-stack/sparkinfer-c40eb08f-full/sparkinfer/gemm/mxfp8_linear/_kernel.py}
MIXED_TRELLIS_OVERLAY=${MIXED_TRELLIS_OVERLAY:-$ROOT/runtime/build-exact-h16-v7/sparkinfer/moe/_shared/kernels/w4a16/mixed_trellis.py}
WORKSPACE_OVERLAY=${WORKSPACE_OVERLAY:-$ROOT/runtime/build-exact-h16-v1/vllm/v1/worker/workspace.py}
B12X_MLA_OVERLAY=${B12X_MLA_OVERLAY:-$ROOT/runtime/active-r634-b12x-compact/b12x_mla_sparse.py}
MLA_ATTENTION_OVERLAY=${MLA_ATTENTION_OVERLAY:-$ROOT/runtime/active-r634-b12x-compact/mla_attention.py}
SPARKINFER_BMM_API_OVERLAY=${SPARKINFER_BMM_API_OVERLAY:-$ROOT/runtime/shared-h-stack/sparkinfer-c40eb08f-full/sparkinfer/gemm/_bmm/api.py}
SPARKINFER_BF16_BMM_OVERLAY=${SPARKINFER_BF16_BMM_OVERLAY:-$ROOT/runtime/shared-h-stack/sparkinfer-c40eb08f-full/sparkinfer/gemm/_shared/bf16_bmm.py}
SPARSE_UTILS_OVERLAY=${SPARSE_UTILS_OVERLAY:-$ROOT/runtime/vllm/vllm/v1/attention/backends/mla/sparse_utils.py}
...
KVARN_MLA_OPS_OVERLAY=${KVARN_MLA_OPS_OVERLAY:-$ROOT/runtime/active-r634-b12x-compact/kvarn_mla.py}
KVARN_CONFIG_OVERLAY=${KVARN_CONFIG_OVERLAY:-$ROOT/runtime/active-r634-b12x-compact/config.py}
KVARN_NATIVE_API_OVERLAY=${KVARN_NATIVE_API_OVERLAY:-$ROOT/runtime/active-r634-b12x-compact/kvarn_api_k4.py}
KVARN_NATIVE_IO_OVERLAY=${KVARN_NATIVE_IO_OVERLAY:-$ROOT/runtime/active-r634-kvarn-k4-native/kvarn_mla/io.py}
KVARN_NATIVE_KERNEL_OVERLAY=${KVARN_NATIVE_KERNEL_OVERLAY:-$ROOT/runtime/active-r634-kvarn-k4-native/_shared/mla/kernel.py}
...
KVARN_MLA_STATE_OVERLAY=${KVARN_MLA_STATE_OVERLAY:-$ROOT/runtime/active-r634-kvarn-k4-native/kvarn_mla_state.py}
KVARN_SINKHORN_OVERLAY=${KVARN_SINKHORN_OVERLAY:-$ROOT/runtime/active-r634-b12x-compact/triton_kvarn_sinkhorn.py}
EAGLE_UTILS_OVERLAY=${EAGLE_UTILS_OVERLAY:-/home/js/projects/optimize-vllm/vllm/v1/worker/gpu/spec_decode/eagle/utils.py}
FLASH_ATTN_OVERLAY=${FLASH_ATTN_OVERLAY:-$ROOT/runtime/build-exact-h16-v1/vllm/v1/attention/backends/flash_attn.py}
FLEX_ATTN_OVERLAY=${FLEX_ATTN_OVERLAY:-$ROOT/runtime/build-exact-h16-v1/vllm/v1/attention/backends/flex_attention.py}
DFLASH_CUDAGRAPH_OVERLAY=${DFLASH_CUDAGRAPH_OVERLAY:-$ROOT/runtime/build-exact-h16-v1/vllm/v1/worker/gpu/spec_decode/dflash/cudagraph.py}
...
DSPARK_UTILS_OVERLAY=${DSPARK_UTILS_OVERLAY:-$ROOT/runtime/build-exact-h16-v1/vllm/v1/worker/gpu/spec_decode/dspark/utils.py}
GLM_DSPARK_MODEL_OVERLAY=${GLM_DSPARK_MODEL_OVERLAY:-$ROOT/runtime/build-exact-h16-v1/vllm/models/deepseek_v4/nvidia/dspark.py}
QWEN3_DFLASH_OVERLAY=${QWEN3_DFLASH_OVERLAY:-$ROOT/runtime/build-exact-h16-v1/vllm/model_executor/models/qwen3_dflash.py}
SPECULATORS_ALGOS_OVERLAY=${SPECULATORS_ALGOS_OVERLAY:-$ROOT/runtime/build-exact-h16-v1/vllm/transformers_utils/configs/speculators/algos.py}
KV_CACHE_UTILS_OVERLAY=${KV_CACHE_UTILS_OVERLAY:-$ROOT/runtime/active-r634-b12x-compact/kv_cache_utils.py}
CACHE_CONFIG_OVERLAY=${CACHE_CONFIG_OVERLAY:-$ROOT/runtime/build-exact-h16-v1/vllm/config/cache.py}
VLLM_CONFIG_OVERLAY=${VLLM_CONFIG_OVERLAY:-$ROOT/runtime/build-exact-h16-v1/vllm/config/vllm.py}
TORCH_UTILS_OVERLAY=${TORCH_UTILS_OVERLAY:-$ROOT/runtime/build-exact-h16-v1/vllm/utils/torch_utils.py}
SPEC_CONFIG_OVERLAY=${SPEC_CONFIG_OVERLAY:-$ROOT/runtime/build-exact-h16-v1/vllm/config/speculative.py}
...
exec podman run --rm --pull=never --replace \
  ...
  --volume "$ROOT/weights/current/mtp:/mtp:ro" \
  $([[ -e ${SPEC_MODEL:-} ]] && echo --volume "${SPEC_MODEL}:/spec-model:ro") \
  --volume "$ROOT/runtime/r634-prefix-overlays/vllm/platforms/cuda.py:/opt/venv/lib/python3.12/site-packages/vllm/platforms/cuda.py:ro" \
  --volume "$ROOT/runtime/r634-mtp-overlays/vllm/v1/attention/backends/mla/indexer.py:/opt/venv/lib/python3.12/site-packages/vllm/v1/attention/backends/mla/indexer.py:ro" \
  --volume "$ROOT/runtime/build-exact-h16-v7/vllm/model_executor/layers/quantization/exl3.py:/opt/venv/lib/python3.12/site-packages/vllm/model_executor/layers/quantization/exl3.py:ro" \
  --volume "$ROOT/runtime/build-exact-h16-v1/vllm/v1/attention/ops/dcp_alltoall.py:/opt/venv/lib/python3.12/site-packages/vllm/v1/attention/ops/dcp_alltoall.py:ro" \
  "${ROUTE_PACK_ARGS[@]}" \
  "${RUNTIME_OVERLAY_ARGS[@]}" \
  --volume "$CACHE:/cache" \
