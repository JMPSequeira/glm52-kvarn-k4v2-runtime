...
_MLA_SM120_KVARN_EXACT_FAST_IO_ENV = (
    "SPARKINFER_MLA_SM120_KVARN_EXACT_FAST_IO"
)
...
# fp8-RoPE record variants: (stride, s_col, zp, s_row, rope, rope_amax).
# Latent layout is unchanged; the RoPE section halves (E4M3 + fp16 amax).
_KVARN_PACKED_TILE_GEOMETRY_FP8: dict[int, tuple[int, ...]] = {
    2: (14_592, 8_192, 9_216, 10_240, 10_368, 14_464),
    4: (22_784, 16_384, 17_408, 18_432, 18_560, 22_656),
...
def _kvarn_mla_decode_grid_flat_launch(
    ...
    LAST_KVARN_DECODE_PLAN.update(
        ...
        marker=(
            "sparkinfer::kvarn_mla_sm120_decode_grid_exact_h16"
            if exact_h16
            else "sparkinfer::kvarn_mla_sm120_decode_grid"
        ),
...
@torch.library.custom_op("sparkinfer::kvarn_mla_sm120_decode_grid", mutates_args=("mid_out", "mid_lse"))
